...
#[Route(
    path: '/settings/[general|brand|billing|payments|credits|rate-providers|affiliates|openai|cohere|anthropic|elevenlabs|falai|stabilityai|gcp|azure|clipdrop|aimlapi|serper|onesignal|mail|smtp|policies|accounts|public-details|recaptcha|appearance|pwa|storage|cdn:name]?',
